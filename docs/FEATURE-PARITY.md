...
| Email / print / clipboard | [P] | ☑ (print + clipboard + drag-out; email from the Scan page and a group: MAPI draft when a client is probed, else Windows Share sheet, else Explorer; PDF or the page files as-is; never sends, never logs a recipient; SPEC-2026-007, ADR-0012) | 4,9,26 |
